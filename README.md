...
The most recent release is Bynder Java SDK 1.0.4, released Jul 26, 2017.
- API Docs: http://www.javadoc.io/doc/com.bynder/bynder-java-sdk/1.0.4
...
```
dependencies {
  compile 'com.bynder:bynder-java-sdk:1.0.4'
}
```
