...
The most recent release is Bynder Java SDK 1.1.2, released May 16, 2018.
- API Docs: http://www.javadoc.io/doc/com.bynder/bynder-java-sdk/1.1.2
...
```
dependencies {
  compile 'com.bynder:bynder-java-sdk:1.1.2'
}
```
