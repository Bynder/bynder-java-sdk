...
The most recent release is Bynder Java SDK 2.2.13.

- API Docs: http://www.javadoc.io/doc/com.bynder/bynder-java-sdk/2.2.13
...
```
dependencies {
  implementation 'com.bynder:bynder-java-sdk:2.2.13'
}
```
