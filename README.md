...
The most recent release is Bynder Java SDK 2.2.0.

- API Docs: http://www.javadoc.io/doc/com.bynder/bynder-java-sdk/2.2.0
...
```
dependencies {
  compile 'com.bynder:bynder-java-sdk:2.2.0'
}
```
