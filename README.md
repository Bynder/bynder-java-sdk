...
The most recent release is Bynder Java SDK 1.0.3, released Jun 27, 2017.
- API Docs: http://www.javadoc.io/doc/com.bynder/bynder-java-sdk/1.0.3
...
```
dependencies {
  compile 'com.bynder:bynder-java-sdk:1.0.3'
}
```
