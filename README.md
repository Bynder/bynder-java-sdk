...
The most recent release is Bynder Java SDK 1.1.1, released May 3, 2018.
- API Docs: http://www.javadoc.io/doc/com.bynder/bynder-java-sdk/1.1.1
...
```
dependencies {
  compile 'com.bynder:bynder-java-sdk:1.1.1'
}
```
